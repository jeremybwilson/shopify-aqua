...
/*============================================================================
  Filter Utils - Shared among sections using filters (Search / PLP)
==============================================================================*/
theme.scripts.filterUtils = (function() {
...
theme.Collection = (function() {
  function Collection(container) {
    ...
    $(document).ready( () => {
      ...
      theme.scripts.filterUtils.init( '#shopify-section-collection-template' );
...
theme.Search = (function() {
  function Search(container) {
    ...
    $(document).ready( () => {
      ...
      // ATTACH : Apply All event
      theme.scripts.filterUtils.init( '#shopify-section-search-template' );
    });
  }
